...
class GetTextArea:
    ...
    def _load_img_new(self, filepath: str):
        ...
        for ifile in filelist:
            img = cv.imread(cv.samples.findFile(filepath + ifile))
            ...
            #сортировки контуров, my_contours - массив контуров, f - прямоугольники построенные по контурам
        ...
        for i, i_cnt in enumerate(f2):
            ...
            cv.putText(mask, f'W:{w} x H:{h}', (l+5, t+20), cv.FONT_HERSHEY_TRIPLEX, 0.5, (255,100,0))
            cv.putText(mask, f'L:{l} x T:{t}', (l+5, t+60), cv.FONT_HERSHEY_TRIPLEX, 0.5, (255,100,0))
